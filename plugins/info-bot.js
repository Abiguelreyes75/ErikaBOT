...
const estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "16479546631-16479546631@g.us" } : {}) },
message: { 
...
const estiloaudio = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "16479546631-16479546631@g.us" } : {}) },
message: { 
