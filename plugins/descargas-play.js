...
let enlace = { contextInfo: { externalAdReply: {title: wm + ' 🐈', body: 'support group' ,  await(await fetch(gata.getRandom())).buffer() }}}
...
{title: "𓃠 𝗔 𝗨 𝗗 𝗜 𝗢 (Opcion 2)", rowId: `${usedPrefix}ytv ${url}`, description: `${title}\n`},
]},{
